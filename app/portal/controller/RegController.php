...
class VvController extends HomeBaseController
{
    private $book_car_manger_email = [
        3=>['7124046@qq.com'],
        5=>['7124046@qq.com','18675521061@163.com']
    ];
    ...
    public function vv5(){
        ...
        if(isMobile()){
            return $this->fetch('vv5_m');
        }
        return $this->fetch('vv5_i');
    }

    public function wey_car_config(){
        $id = I('style_id');
        $id = $id?(int)$id:1;
        $tpl = 'wey_config_'.$id;
    ...
    public function testDrive(){
        $style_id = I('style_id');
        if($style_id == 1){
            $this->assign('select_car',['name'=>'WEY P8','id'=>1]);
        }else if($style_id == 2){
            $this->assign('select_car',['name'=>'WEY VV5','id'=>2]);
        }else if($style_id == 3){
            $this->assign('select_car',['name'=>'WEY VV7','id'=>3]);
        }
    ...
    public function weyvv7(){
	 ...
	 public function wey_vv5_vv7(){
        return $this->fetch('wey_vv5_vv7');
    }
}
