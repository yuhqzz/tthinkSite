...
var Web = {
	...
	tableScroll: function(){
		$.get("/portal/vv/vv5Config.html", function(data) {
			$("#tableBox2").html(data);
			setTimeout(function(){
		...
		$.get("/portal/vv/vv7Config.html", function(data) {
			$("#tableBox").html(data);
			setTimeout(function(){
		...
		$('#vv7Scroll').hide();
		$('#p8Scroll').hide();
		$.get("/portal/vv/p8Config.html", function(data) {
			$("#tableBox3").html(data);
			setTimeout(function(){
	...
	testDirve: function(){
		$.get("/portal/vv/testDrive.html?style_id=2", function(data) {
			$("#testDrive").html(data);
	...
	cluoInit:function(){
		...
		for( var i=1; i < 16; i++){
			tmp += '<div class="item">' +
				'<img src="/themes/txqc/public/assets/vv/images/hot_img/vv5/'+i+'.jpg" alt="">' +
				'</div>';
		}
		$('.pic1_box').html(tmp);
